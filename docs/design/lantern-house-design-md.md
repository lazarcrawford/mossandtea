...
components:
  shell:
    ...
    texture: "thin plank lines, candle bloom, low film grain"
  masthead:
    shape: "wooden pavilion with visible brass instrument card"
...
Use a dark photographic field, but let it behave like an interior wall. Add a warm lower glow and a cool horizon leak. Keep copy short. Place the instrument card as an object in the room.
